...
//    }
    ...
    override func viewDidLoad() {
        UILabel.appearance().substituteFontName = "beINNormal"; // USE YOUR FONT NAME INSTEAD
        UITextView.appearance().substituteFontName = "beINNormal"; // USE YOUR FONT NAME INSTEAD
        UITextField.appearance().substituteFontName = "beINNormal"; // USE YOUR FONT NAME INSTEAD
    }
